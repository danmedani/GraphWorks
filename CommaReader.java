...
/**
 * CommaReader is a subclass of GraphReader that is able to parse input files
...
public class CommaReader extends GraphReader {
     ...
     */
    public CommaReader(String inString, boolean weighted){
