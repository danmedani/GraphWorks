...
/**
 * <code>EulerDisplayPanel</code> displays a after performing a given search 
 * on it.
 *
 * @author 
 * @version 1.0
 */
public class EulerDisplayPanel extends JPanel 
    ...
    /**
     * Creates a new <code>EulerDisplayPanel</code> instance.
     *
     * @param e 2-d edge array with graph data.
     * @param t 2-d edge array of tree edges.
     */
    public EulerDisplayPanel(int[][] e, int[][][] t){
	...
	if(hasEulerCircuit) {
		...
		if(currentEdge != (treeEdges[currentStartVertex].length-1) &&
		   treeEdges[currentStartVertex][currentEdge][2] != -1) {
