/**
 * <code>ConDisplayPanel</code> draws a graph with its vertices reordered
...
public class ConDisplayPanel extends GraphDisplayPanel {
    ...
    /**
     * Creates a new <code>ConDisplayPanel</code> instance.
     *
     * @param e an <code>int</code> value
     * @param order an <code>int</code> value
     */
    public ConDisplayPanel(int[][] e, int[] order){
	super(e,false);
	vOrder = order;
	...
	g.drawString("Connected Components", 50, 10);
